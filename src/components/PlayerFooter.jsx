...
function PlayerFooter() {
  return (
    <div style={{position:'absolute',zIndex:2,background: '#000', bottom: '0px'}} className="container-fluid py-2">
        <div className="d-flex align-items-center w-100">
            <div className="col-md-3">
                <div className="d-flex align-items-center">
                    <div>
                        <img style={{borderRadius: '5px'}} src={album1} height={'50px'} width={'50px'} />
                    </div>
                    <div className='ms-3'>
                        <p style={{fontWeight: '500'}} className="my-0 text-white">ALL MINE</p>
                        <p style={{color: '#b3b3b3', fontSize: '14px'}} className='my-0'>Brent Faiyaz</p>
                    </div>
                        <Icon style={{color: '#1ed760'}} className='hasNavigationMenuIcon ms-4' icon="material-symbols-light:check-circle" />
                </div>
            </div>
            <div className="col-md-6">
                <div className="d-flex align-items-center justify-content-center">
                    ...
                    <button className="btn">
                        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" class="Svg-sc-ytk21e-0 kPpCsU" width="15" height="15">
                            <path fill="#b3b3b3" d="M13.151.922a.75.75 0 1 0-1.06 1.06L13.109 3H11.16a3.75 3.75 0 0 0-2.873 1.34l-6.173 7.356A2.25 2.25 0 0 1 .39 12.5H0V14h.391a3.75 3.75 0 0 0 2.873-1.34l6.173-7.356a2.25 2.25 0 0 1 1.724-.804h1.947l-1.017 1.018a.75.75 0 0 0 1.06 1.06L15.98 3.75 13.15.922zM.391 3.5H0V2h.391c1.109 0 2.16.49 2.873 1.34L4.89 5.277l-.979 1.167-1.796-2.14A2.25 2.25 0 0 0 .39 3.5z"></path>
                            <path fill="#b3b3b3" d="m7.5 10.723.98-1.167.957 1.14a2.25 2.25 0 0 0 1.724.804h1.947l-1.017-1.018a.75.75 0 1 1 1.06-1.06l2.829 2.828-2.829 2.828a.75.75 0 1 1-1.06-1.06L13.109 13H11.16a3.75 3.75 0 0 1-2.873-1.34l-.787-.938z"></path>
                        </svg>
                    </button>
                    {/* previous icon */}
                    <button className="btn">
                        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16"
                            class="Svg-sc-ytk21e-0 kPpCsU" width="15" height="15">
                            <path fill="#b3b3b3"
                    ...
                    {/* play icon */}
                    <button style={{borderRadius: '100%', height: '35px', width: '35px'}} className="btn bg-white d-flex mx-2 align-items-center justify-content-center p-2">
                        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16"
                            class="Svg-sc-ytk21e-0 kPpCsU" width="25" height="25">
                            <path 
                ...
                <div className="d-flex align-items-center justify-content-center mt-1 w-100">
                    <small style={{fontSize:'11px', color: '#b3b3b3'}}>0:00</small>
                     <div className='mx-1' style={{width:'75%', height: '4px', background: '#ffffff4d', borderRadius: '5px'}}></div>
                    <small style={{fontSize:'11px', color: '#b3b3b3'}}>-4:44</small>
                </div>
            </div>
            <div className="col-md-3">
                <div className="d-flex align-items-center justify-content-end mt-2">
                      ...
                      <button className="btn px-2">
                          <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16"
                              class="Svg-sc-ytk21e-0 kPpCsU" width="15" height="15">
                              <path fill='#b3b3b3' d="M11.196 8 6 5v6l5.196-3z"></path>
                              <path fill='#b3b3b3'
                      ...
                      <button className="btn px-2">
                          <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16"
                              class="Svg-sc-ytk21e-0 kPpCsU" width="15" height="15" fill="#b3b3b3">
                              <path
                      ...
                      <button className="btn px-2">
                          <svg data-encore-id="icon" role="presentation" aria-hidden="true"
                              class="Svg-sc-ytk21e-0 kPpCsU" width="15" height="15" fill="#b3b3b3" viewBox="0 0 16 16">
                              <path
                      ...
                      <button className="btn px-2">
                          <svg data-encore-id="icon" role="presentation" aria-label="Volume high" aria-hidden="true"
                              id="volume-icon" viewBox="0 0 16 16" class="Svg-sc-ytk21e-0 dAOlPY" width="15" height="15"
                              fill="#b3b3b3">
                              <path
                      ...
                      <div className='mx-1 mt-1' style={{width:'30%', height: '4px', background: '#fff', borderRadius: '5px'}}></div>
                      {/* extend icon */}
                      <button className="btn px-2">
                          <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16"
                              class="Svg-sc-ytk21e-0 kPpCsU" width="15" height="15" fill="#b3b3b3">
